...
# interchangeable and are related by the above equation. You should ask the user for mass (m) in 
# kilograms and use a constant value for the speed of light -- C = 299792458 m/s.
