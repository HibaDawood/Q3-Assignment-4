...
# A leap year (also known as an intercalary year or bissextile year) is a calendar year that 
# contains an additional day (or, in the case of a lunisolar calendar, a month) added to keep 
# the calendar year synchronized with the astronomical year or seasonal year. In the Gregorian 
# calendar, each leap year has 366 days instead of 365, by extending February to 29 days rather 
# than the common 28.
