...
# There are times where we want to return different things from a function based on some 
# condition. To practice this idea, imagine that we want to check if someone is an adult. 
# We might check their age and return different things depending on how old they are!

# We've provided you with the ADULT_AGE variable which has the age a person is legally 
# classified as an adult (in the United States). Fill out the is_adult(age) function, 
