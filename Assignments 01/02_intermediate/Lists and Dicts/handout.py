...
# This exercise will help you get comfortable with indexing, slicing, and modifying list 
# elements.

# ## Instructions:
# ### Initialize a List:
# Create a list with at least 5 different elements. They can be numbers, strings, or a mix of 
# both.
...
# - Returns a new list containing the elements from the start index up to (but not including) 
# the end index.
